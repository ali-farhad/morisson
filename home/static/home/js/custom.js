...
$(document).ready(function() {
    ...
    $('.owl-carousel-team').owlCarousel( {
        loop: true, margin: 10, responsiveClass: true, responsive: {
            ...
            , 1000: {
                items: 4, nav: true, loop: true, margin: 30
            }
        }
    }
    )
    ...
    $('.client_slider_main').owlCarousel( {
        items: 1, margin: 10, autoHeight: false
    }
    );
    /** half slider **/
    var owl=$('.owl-carousel_haf');
    owl.owlCarousel( {
        stagePadding: 50, margin: 30, nav: true, loop: true, responsive: {
            0: {
                items: 1
            }
            , 600: {
